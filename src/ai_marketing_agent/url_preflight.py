...
biometric-mouse (her zaman), semantic-browser (observe), ve auto_ensemble captcha (capsolver→2captcha→ai-captcha→buster)
aktif olarak kullanılır, çünkü preflight’ta bile captcha/koruma çıkabilir. Vault: vault://mouse/profile/mouse_profile.json,
vault://captcha/capsolver/apiKey, vault://captcha/2captcha/apiKey, vault://llm/openai/apiKey, vault://proxy/residential/uri.
"""
